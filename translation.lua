return {
    bg = {
        controlsDescription = '[%s] - За да освободиш заложника [%s] - За да го убиеш',
        fail_dead_ped = 'Човекът е мъртъв!',
        fail_dead_ped_in_veh = 'Човекът е мъртъв и е в кола!',
    ...
    en = {
        ...
        fail_dead_ped = 'The hostage is dead!',
        fail_dead_ped_in_veh = 'This human is dead and it\'s in a car',
    ...
    de = {
        ...
        fail_dead_ped_in_veh = 'Der Mann ist tot und in einem Auto!',
    ...
    ru = {
        ...
        fail_dead_ped = 'Парень мертв!',
        fail_dead_ped_in_veh = 'Мужчина мертв и находится в машине!',
    ...
    it = {
        ...
        fail_dead_ped = 'Il ragazzo è morto!',
        fail_dead_ped_in_veh = 'L\'uomo è morto ed è in macchina!',
